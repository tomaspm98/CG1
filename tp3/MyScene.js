...
export class MyScene extends CGFscene {
    ...
    updateAmbientLight() {
        this.setGlobalAmbientLight(this.ambLightIntensity, this.ambLightIntensity, this.ambLightIntensity, 1.0);
    }
    ...
    initMaterials() {
        ...
        this.woodMaterial.setDiffuse(0.51, 0.26, 0.2, 1.0);
